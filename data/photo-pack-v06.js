(() => {
  ...
  const updates = {
    "dzbankowka-kulista": {
      ...
      image: commonsImage("Sarcosoma globosum.jpg"),
      ...
      image_source: "https://commons.wikimedia.org/wiki/File:Sarcosoma_globosum.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Sarcosoma_globosum.jpg",
      image_modifications: embeddedFromCommons,
      tags: ["beczułka", "rzadki workowiec", "ciemny"]
    },
    "czareczka-dlugotrzonkowa": {
      image_status: "commons_candidate",
      image: commonsImage("Microstoma protractum.jpg"),
      image_alt: "Czareczka długotrzonkowa (Microstoma protractum), mały czerwony czarkowaty owocnik na długim trzonku",
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Microstoma_protractum.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Microstoma_protractum.jpg",
      image_modifications: embeddedFromCommons,
    ...
    "kolczakowka-wonna": {
      image_status: "commons_candidate",
      image: commonsImage("Hydnellum suaveolens.jpg"),
      image_alt: "Kolczakówka wonna (Hydnellum suaveolens), bladoniebieskawy owocnik z kolczastym hymenoforem",
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Hydnellum_suaveolens.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Hydnellum_suaveolens.jpg",
      image_modifications: embeddedFromCommons,
    ...
    "pniarek-lekarski": {
      image_status: "commons_candidate",
      image: commonsImage("Fomitopsis officinalis.jpg"),
      image_alt: "Pniarek lekarski (Fomitopsis officinalis), jasny wieloletni owocnik huby na pniu drzewa",
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Fomitopsis_officinalis.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Fomitopsis_officinalis.jpg",
      image_modifications: embeddedFromCommons,
    ...
    "gestoporek-cynobrowy": {
      image_status: "commons_candidate",
      image: commonsImage("Pycnoporus cinnabarinus.jpg"),
      image_alt: "Gęstoporek cynobrowy (Pycnoporus cinnabarinus), intensywnie pomarańczowo-czerwony owocnik na martwym drewnie",
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Pycnoporus_cinnabarinus.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Pycnoporus_cinnabarinus.jpg",
      image_modifications: embeddedFromCommons,
      tags: ["cynober", "martwe drewno", "pomarańczowy"]
    },
    "maczuznik-bojowy": {
      image_status: "commons_candidate",
      image: commonsImage("Cordyceps militaris.jpg"),
      ...
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Cordyceps_militaris.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Cordyceps_militaris.jpg",
      image_modifications: embeddedFromCommons,
      tags: ["owady", "maczugi", "pomarańczowy"]
    },
    "maczuznik-nasiezrzalowy": {
      image_status: "commons_candidate",
      image: commonsImage("Tolypocladium ophioglossoides.jpg"),
      ...
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Tolypocladium_ophioglossoides.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Tolypocladium_ophioglossoides.jpg",
      image_modifications: embeddedFromCommons,
      tags: ["pasożyt", "maczuga", "podziemne grzyby"]
    },
    "czasznica-olbrzymia": {
      image_status: "commons_candidate",
      image: commonsImage("Calvatia gigantea.jpg"),
      image_alt: "Czasznica olbrzymia (Calvatia gigantea), duży biały kulisty owocnik na trawie",
      image_author: "do weryfikacji w Wikimedia Commons",
      image_source: "https://commons.wikimedia.org/wiki/File:Calvatia_gigantea.jpg",
      image_license: "do weryfikacji",
      license_url: "https://commons.wikimedia.org/wiki/File:Calvatia_gigantea.jpg",
      image_modifications: embeddedFromCommons,
  ...
  appData.version = "0.6.0-photo-pack-5";
  appData.last_updated = "2026-05-08";
  appData.photo_pack_5 = {
    ...
    note: "Ostatnia paczka domykająca brakujące zdjęcia. Nie nadpisuje zdjęć już oznaczonych jako commons_verified; nowe linki są kandydatami do końcowej weryfikacji atrybucji."
  };
})();
